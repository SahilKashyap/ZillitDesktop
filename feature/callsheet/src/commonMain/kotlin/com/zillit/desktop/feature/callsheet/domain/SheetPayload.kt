 ...
 *
 * CamelCase on the wire — the one part of the payload that is, so the codec
 * treats it separately. Day counts are STRING-encoded numbers ("5" of "35"),
 * and [dateMs] is epoch milliseconds at local midnight.
 */
